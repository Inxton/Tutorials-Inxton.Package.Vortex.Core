...
namespace RoomController
{
	...
	public partial interface IShadowRoomControllerTwinController
	{
		...
		RoomController.PlainRoomControllerTwinController CreatePlainerType();
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainRoomControllerTwinController : System.ComponentModel.INotifyPropertyChanged, Vortex.Connector.IPlain
	{
		PlainIO _IO;
		public PlainIO IO
		{
		...
		public PlainHardware_Simulation Hardware_Simulation
		{
			...
			set
			{
				if (_Hardware_Simulation != value)
				{
					_Hardware_Simulation = value;
					PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(Hardware_Simulation)));
				}
			}
		}
