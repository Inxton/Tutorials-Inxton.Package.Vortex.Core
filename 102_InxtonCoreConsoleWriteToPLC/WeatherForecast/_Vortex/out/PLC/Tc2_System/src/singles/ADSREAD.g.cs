...
namespace Tc2_System
{
            ...
            /// <exclude />
	[IgnoreReflection()]
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty Name \"\" }", "ADSREAD", "Tc2_System", TypeComplexityEnum.Complex)]
	public partial class ADSREAD : Vortex.Connector.IVortexObject, IADSREAD, IShadowADSREAD, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineUDInt IADSREAD.IDXGRP
		{
			get
			{
				return IDXGRP;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowUDInt IShadowADSREAD.IDXGRP
		{
			get
			{
				return IDXGRP;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineUDInt IADSREAD.IDXOFFS
		{
			get
			{
				return IDXOFFS;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowUDInt IShadowADSREAD.IDXOFFS
		{
			get
			{
				return IDXOFFS;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineUDInt IADSREAD.LEN
		{
			get
			{
				return LEN;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowUDInt IShadowADSREAD.LEN
		{
			get
			{
				return LEN;
		...
		Vortex.Connector.ValueTypes.OnlinerBool _READ;
		public Vortex.Connector.ValueTypes.OnlinerBool READ
		{
			get
			{
				return _READ;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IADSREAD.READ
		{
			get
			{
				return READ;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowADSREAD.READ
		{
			get
			{
				return READ;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineTime IADSREAD.TMOUT
		{
			get
			{
				return TMOUT;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowTime IShadowADSREAD.TMOUT
		{
			get
			{
				return TMOUT;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IADSREAD.BUSY
		{
			get
			{
				return BUSY;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowADSREAD.BUSY
		{
			get
			{
				return BUSY;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IADSREAD.ERR
		{
			get
			{
				return ERR;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowADSREAD.ERR
		{
			get
			{
				return ERR;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineUDInt IADSREAD.ERRID
		{
			get
			{
				return ERRID;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowUDInt IShadowADSREAD.ERRID
		{
			get
			{
				return ERRID;
		...
		public PlainADSREAD CreatePlainerType()
		{
			var cloned = new PlainADSREAD();
			return cloned;
		}

		protected PlainADSREAD CreatePlainerType(PlainADSREAD cloned)
		{
			return cloned;
		}
		...
		public void FlushPlainToOnline(Tc2_System.PlainADSREAD source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Tc2_System.PlainADSREAD source)
		{
		...
		public void FlushOnlineToPlain(Tc2_System.PlainADSREAD source)
		{
			this.Read();
		...
		public ADSREAD(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
			...
			_READ = @Connector.Online.Adapter.CreateBOOL(this, "", "READ");
		...
		public ADSREAD()
		{
			...
			_READ = Vortex.Connector.IConnectorFactory.CreateBOOL();
            ...
            /// </summary>
            /// <exclude />
	public partial interface IADSREAD : Vortex.Connector.IVortexOnlineObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool READ
		{
			get;
		}
		...
		Tc2_System.PlainADSREAD CreatePlainerType();
		void FlushOnlineToShadow();
		void FlushPlainToOnline(Tc2_System.PlainADSREAD source);
		void FlushOnlineToPlain(Tc2_System.PlainADSREAD source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial interface IShadowADSREAD : Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool READ
		{
			get;
		}
		...
		void CopyPlainToShadow(Tc2_System.PlainADSREAD source);
	}
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainADSREAD : Vortex.Connector.IPlain
	{
		...
		public void CopyPlainToCyclic(Tc2_System.ADSREAD target)
		{
			target.IDXGRP.Cyclic = IDXGRP;
			target.IDXOFFS.Cyclic = IDXOFFS;
			target.LEN.Cyclic = LEN;
			target.READ.Cyclic = READ;
		...
		public void CopyPlainToCyclic(Tc2_System.IADSREAD target)
		{
			this.CopyPlainToCyclic((Tc2_System.ADSREAD)target);
		}

		public void CopyPlainToShadow(Tc2_System.ADSREAD target)
		{
			target.IDXGRP.Shadow = IDXGRP;
			target.IDXOFFS.Shadow = IDXOFFS;
			target.LEN.Shadow = LEN;
			target.READ.Shadow = READ;
		...
		public void CopyPlainToShadow(Tc2_System.IShadowADSREAD target)
		{
			this.CopyPlainToShadow((Tc2_System.ADSREAD)target);
		}

		public void CopyCyclicToPlain(Tc2_System.ADSREAD source)
		{
			IDXGRP = source.IDXGRP.LastValue;
			IDXOFFS = source.IDXOFFS.LastValue;
			LEN = source.LEN.LastValue;
			READ = source.READ.LastValue;
		...
		public void CopyCyclicToPlain(Tc2_System.IADSREAD source)
		{
			this.CopyCyclicToPlain((Tc2_System.ADSREAD)source);
		}

		public void CopyShadowToPlain(Tc2_System.ADSREAD source)
		{
			IDXGRP = source.IDXGRP.Shadow;
			IDXOFFS = source.IDXOFFS.Shadow;
			LEN = source.LEN.Shadow;
			READ = source.READ.Shadow;
		...
		public void CopyShadowToPlain(Tc2_System.IShadowADSREAD source)
		{
			this.CopyShadowToPlain((Tc2_System.ADSREAD)source);
		}
