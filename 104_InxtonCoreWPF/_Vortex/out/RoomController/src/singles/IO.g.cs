...
namespace RoomController
{
	...
	public partial class IO : Vortex.Connector.IVortexObject, IIO, IShadowIO, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		stAi4CH _hwAirDataIN;
		public stAi4CH hwAirDataIN
		{
			get
			{
				return _hwAirDataIN;
		...
		IShadowstAi4CH IShadowIO.hwAirDataIN
		{
			get
			{
				return hwAirDataIN;
		...
		public IO(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
			...
			_hwAirDataIN = new stAi4CH(this, "", "hwAirDataIN");
			AttributeName = "";
	...
	{
		PlainstAi4CH _hwAirDataIN;
		public PlainstAi4CH hwAirDataIN
		{
			get
			{
				return _hwAirDataIN;
